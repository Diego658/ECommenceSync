...
class SideNavOuterToolbar extends React.Component {
  ...
  render() {
    const { menuItems, title, location, userMenuItems, configuraciones, configuracion, onConfiguracionChanged } = this.props;
    const {
      menuOpened,
      menuMode,
      shaderEnabled,
    ...
    return (
      <div className={'side-nav-outer-toolbar'}>
        <Header
          ...
          onConfiguracionChanged={onConfiguracionChanged}
        />
